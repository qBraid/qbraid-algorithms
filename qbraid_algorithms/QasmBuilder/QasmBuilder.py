...
class GateBuilder(FileBuilder):
    ...
    def __init__(self):
        """
        Initialize gate builder with base functionality.
        
        Inherits all core functionality from FileBuilder while
...
class IncludeBuilder(FileBuilder):
    ...
    def __init__(self):
        """
        Initialize include file builder.
        
        Inherits base functionality while specializing for include
